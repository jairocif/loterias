...
const API = "https://loterias-production-2450.up.railway.app";
...
export default function App() {
  ...
  // Si estamos en modo generador, mostrar ese componente
  if (showGenerator && game) {
    return (
      <Generator
        game={game}
          ...
          <section style={styles.card}>
                ...
                <div style={styles.block}>
                  {!country && (
                    <input
                      ...
                      placeholder={
                        lang === "es" ? "Buscar país..." : "Search country..."
                      }
                      style={styles.input}
                    />
                  )}
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      const c = countries.find(
                        (x) => String(x.iso2) === String(country)
                      );
                      setQ(c ? c.label : "");
                    }}
                    disabled={!country}
            ...
            {game && (
              <div style={styles.pill}>
                <div style={styles.pillKey}>
                  {lang === "es"
                    ? "Juego seleccionado"
                    : "Selected game"}
                </div>
                <div style={styles.pillVal}>{selectedGameName}</div>
              </div>
            )}
          </section>
        </main>
